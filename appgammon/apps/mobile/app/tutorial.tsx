        ...
        >
          <Animated.View entering={FadeInDown.delay(50).duration(320)}>
            <LiquidGlass style={[styles.panel, Shadows.sm]}>
              <SectionIntro
                eyebrow="Match"
                title="Race to the total your table agreed on"
              >
                <BodyLine>
          ...
          <Animated.View entering={FadeInDown.delay(90).duration(320)}>
            <LiquidGlass style={[styles.panel, Shadows.sm]}>
              <SectionIntro eyebrow="Finishing a game" title="Clear the board ahead of your opponent">
                <BodyLine>
          ...
          <Animated.View entering={FadeInDown.delay(170).duration(320)}>
            <LiquidGlass style={[styles.panel, Shadows.sm]}>
              <SectionIntro eyebrow="Board basics" title="Same start, opposite directions">
                ...
                <MutedLine>In the live table you will see the exact layout—this screen stays high level.</MutedLine>
              </SectionIntro>
            </LiquidGlass>
          </Animated.View>
        </ScrollView>
