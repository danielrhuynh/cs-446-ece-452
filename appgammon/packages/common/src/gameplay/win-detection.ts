...
import type { Board, Bar, BorneOff, PlayerRole } from "../types";
import { CHECKERS_PER_PLAYER } from "../types";
...
export function calculateGamePoints(
  ...
  const [winnerHomeStart, winnerHomeEnd] = winnerRole === "player1" ? [18, 23] : [0, 5];
